      ...
      <div className="max-w-4xl mx-auto pb-10">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <Bookmark className="text-indigo-600 dark:text-indigo-400" /> Saved Jobs
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Review and manage the jobs you've flagged for later.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {validSavedJobs.map(sj => (
              <div key={sj._id} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 hover:shadow-lg transition-shadow flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-2xl border border-dashed border-slate-300 dark:border-slate-800">
            ...
            <h3 className="text-xl font-bold text-slate-700 dark:text-slate-300 mb-2">No Saved Jobs</h3>
